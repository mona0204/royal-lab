				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">About <span>Lab Med</span></div>
			...
			<div class="row">
				...
				<div class="col-lg-5 boxes_col">
					...
					<div class="img working_hours">
						<div class="img d-flex flex-column align-items-start justify-content-center"><img  class="hero"src="images/dept_1.jpg">
					<br><br>
