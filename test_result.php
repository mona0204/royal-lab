...
<!--======  main STYLESHEETS ======-->
<link rel="stylesheet" type="text/css" href="styles/test-result.css">
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class=" fill main_nav ml-auto">
								<ul>
									...
									<li><a href="news.html">TEST LIBRARY</a></li>
...
<ul class="breadcrumb">
  ...
  <h5 style="text-align:center;">Date: 12/01/2019</h5>
<div class="row">
  <div class="col-sm-6">
<h5>Patient Name: Ahmed Salem</h5>
</div>
  <div class="col-sm-6">
<h5 style="float:right;">Age: 35 Years</h5>
</div>
</div>
<hr />
...
<ul class="list-group">
	...
	<img src="images/form.png" width="60px">&nbsp;|&nbsp;<a href="#">Complete Blood Test</a>
	</li>
</ul>
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_news footer_column">
							...
							<ul>
								<li>
									<div class="footer_news_title"><a href="news.html">Aliquam ac eleifend metus 2019</a></div>
									
								</li>
								<li>
									<div class="footer_news_title"><a href="news.html">Donec in libero sit amet mi vulputate 2019</a></div>
